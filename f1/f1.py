...
class F1(commands.Cog):
    ...
    async def pilotos(self, ctx):
        ...
        try:
            ...
            session = fastf1.get_session(last_event['RoundNumber'], last_event['EventName'], 'R')
            session.load()
    ...
    async def constructor(self, ctx):
        ...
        try:
            ...
            for team, row in constructor_standings.iterrows():
                standings_message += f"{team}: {row['Points']} puntos\n"
