...
class Args(Converter):
    ...
    async def convert(self, ctx, argument):
        ...
        # Setting arguments (default=None so guild defaults can be applied)
        parser.add_argument("--multientry", action="store_true", default=None)
        parser.add_argument("--notify", action="store_true", default=None)
        parser.add_argument("--congratulate", action="store_true", default=None)
        parser.add_argument("--announce", action="store_true", default=None)
        parser.add_argument("--ateveryone", action="store_true", default=None)
        parser.add_argument("--athere", action="store_true", default=None)
        parser.add_argument("--show-requirements", action="store_true", default=None)
        parser.add_argument("--update-button", action="store_true", default=None)
...
class EditArgs(Args):
    """Like Args but does not require prize and duration/end fields."""
