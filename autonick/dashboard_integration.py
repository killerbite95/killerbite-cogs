...
Provides per-guild web interface for managing nickname settings and forbidden words.
"""
import typing
...
class DashboardIntegration:
    ...
    async def rpc_autonick_page(self, guild_id: int, **kwargs) -> typing.Dict[str, typing.Any]:
        ...
        # Check if current user is bot owner (for forbidden words section)
...
<div class="trini-tp-settings">
  ...
  <p class="trini-tp-subtitle">Gestión de apodos automáticos</p>

  <div class="trini-tp-guild-section">
    <div class="trini-tp-guild-header">
      <h4><i class="fa fa-cog me-1"></i> Configuración</h4>
      {% if channel_name %}
        <span class="badge bg-gradient-success">{{ channel_name }}</span>
      {% else %}
        <span class="badge bg-gradient-secondary">Sin canal</span>
      {% endif %}
      <span class="badge bg-gradient-info ms-1">Cooldown: {{ cooldown }}s</span>
    </div>
    ...
    <form method="POST" class="mt-3">
      ...
      <div class="row align-items-end">
        ...
        <div class="col-lg-3 col-md-4 mb-3">
          ...
          <input type="number" class="form-control form-control-sm" name="cooldown" value="{{ cooldown }}" min="0" max="86400">
        </div>
